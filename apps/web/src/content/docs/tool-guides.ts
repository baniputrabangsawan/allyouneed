...
export const toolGuides: Record<string, ToolGuide> = {
  ...
  'merge-png': {
    ...
    steps: [
      ...
      'Choose Vertical, Horizontal, or Grid, then set gap, padding, alignment, and background.',
      'Merge PNG to build the combined image in this browser.',
    ...
    optionDocs: [
      ...
      { name: 'Sizing', description: 'Original keeps native pixel size. Fit uniformly scales every image into the largest source box without stretching. Fit to largest width or height scales to that side. Custom cell size contains each image in a box you set.' },
      ...
      { name: 'Gap / Padding', description: 'Gap is space between images. Padding is the outer margin around the whole canvas.' },
    ...
    output: 'One PNG with preview, final dimensions, file size, image count, and layout. Download stays on this page.',
