...
export const toolGuidesId: Record<string, ToolGuide> = {
  ...
  'merge-png': {
    ...
    steps: [
      ...
      'Pilih Vertikal, Horizontal, atau Grid, lalu atur jarak, padding, perataan, dan latar.',
      'Gabungkan PNG untuk membuat gambar gabungan di browser ini.',
      'Pratinjau hasilnya dan unduh PNG.',
    ],
    optionDocs: [
      ...
      { name: 'Ukuran', description: 'Ukuran asli menjaga piksel native. Sesuaikan seragam menskalakan setiap gambar ke kotak sumber terbesar tanpa meregang. Sesuaikan ke lebar atau tinggi terbesar menskala ke sisi itu. Ukuran sel kustom memuat setiap gambar dalam kotak yang Anda tentukan.' },
      ...
      { name: 'Jarak / Padding', description: 'Jarak adalah spasi antar gambar. Padding adalah margin luar di sekeliling seluruh kanvas.' },
    ...
    output: 'Satu PNG dengan pratinjau, dimensi akhir, ukuran file, jumlah gambar, dan tata letak. Unduhan tetap di halaman ini.',
